...
import type { RazorpaySettings, SmtpSettings, SiteSettings, FaqItem, Testimonial, FooterSettings, ScreenshotsSettings, MarketingSettings, ServiceTypeSetting, PolicySettings, GoogleApiSettings, OutlookApiSettings, AboutSettings, SeoSettings } from './types';
