                ...
                <div>
                    ...
                    <ul className="mt-4 space-y-2">
                        {footerLinks.map(link => (
                           <li key={link.id}><Link href={link.url} className="text-sm text-muted-foreground hover:text-foreground">{link.name}</Link></li>
                        ))}
                    </ul>
                </div>
                 <div>
                    ...
                    <ul className="mt-4 space-y-2">
                        <li><Link href="/terms-of-service" className="text-sm text-muted-foreground hover:text-foreground">Terms and Conditions</Link></li>
