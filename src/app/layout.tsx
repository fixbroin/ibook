...
export const metadata: Metadata = {
  ...
  title: {
    default: 'BookWise - Smart Booking for Professionals',
    template: `%s | BookWise`,
  },
  ...
  openGraph: {
    title: 'BookWise - Smart Booking for Professionals',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'BookWise - Smart Booking Platform',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'BookWise - Smart Booking for Professionals',
    description: 'Simplify your scheduling and grow your business with BookWise, the smart booking platform.',
