...
import { LayoutDashboard, Settings, User as UserIcon, Loader2, CalendarCheck, LogOut, CreditCard, CalendarX, Home, CalendarDays, Bell, ConciergeBell, Blocks } from "lucide-react";
      ...
      <Sidebar>
        ...
        <SidebarContent>
          <SidebarMenu>
            ...
            <NavMenuItem href="/payment-gateway-setup" tooltip="Payment Gateway" icon={Blocks}>
