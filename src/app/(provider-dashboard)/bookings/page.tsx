...
import { Eye, Check, X, Trash2, Loader2, Calendar, Clock, User, Mail, Phone, MapPin, Globe, CalendarPlus, BadgeCent } from "lucide-react";
                     ...
                     {booking.payment && (
                         <div className="space-y-3 rounded-lg border bg-muted/50 p-4 mt-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-medium">Paid ₹{booking.payment.amount.toLocaleString()} Online</span>
                            </div>
                            <div className="flex items-center gap-3">
