      ...
      const verifySignature = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                // Now we just wait for the webhook to update the provider's state.
                // We can optionally poll the provider data to update the UI faster.
                setTimeout(() => {
                   if (user?.email) fetchInitialData(user.email.split('@')[0]);
                }, 3000); // Give webhook 3 seconds
            } else {
