...
import { CheckCircle, Calendar, Clock, MapPin, Sparkles, Loader2, Globe, User, Briefcase, Mail, Phone, BadgeCent } from 'lucide-react';
...
function ConfirmationContent() {
    ...
    const { formattedDate, formattedTime, calendarLinks } = useMemo(() => {
        ...
        const eventLocation = encodeURIComponent(address || 'Online');
    ...
    }, [dateTime, dateFormat, timezone, providerName, serviceType, address]);
