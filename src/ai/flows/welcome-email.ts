...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an email copywriter for a company called BookWise. Your task is to generate a friendly and professional welcome email in HTML format.
...
1.  **Subject Line:** "Welcome to BookWise!"
2.  **Email Body (HTML):**
