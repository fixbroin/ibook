...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an email writer for BookWise. Your task is to generate a subscription confirmation email in HTML format.
...
1.  **Subject Line:** Based on whether it's a renewal or a new subscription.
    *   New: "Your BookWise Subscription is Active!"
    *   Renewal: "Your BookWise Subscription has been Renewed"
2.  **Email Body (HTML):**
    ...
    *   If the plan is 'Lifetime', use a different message like: "You now have lifetime access to BookWise. Thank you for your support!"
    *   Include a call-to-action button to go to the dashboard.
    *   End with a closing like "Thank you for choosing BookWise!".
`,
});
