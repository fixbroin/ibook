...
const personalizedBookingConfirmationPrompt = ai.definePrompt({
  ...
  prompt: `You are an email marketing specialist for a company called BookWise. Your task is to create a personalized booking confirmation email.
...
2.  **Email Body (HTML):**
    ...
    *   End with a professional closing (e.g., "Best regards,<br>The BookWise Team").
`,
});
